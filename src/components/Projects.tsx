...
const featured = [
  ...
  {
    num: "002", label: "Microservices · Social Graph · Kafka",
    title: "LinkedIn-Style Social Network Platform",
    description: "Distributed social networking system on Neo4j graph DB and Kafka event streaming. Gateway-level JWT auth via custom filter (X-User-Id propagation, ThreadLocal context), first/second-degree connection traversal, fan-out post notifications per connection, and full Zipkin + Micrometer distributed tracing across all six services.",
    tags: ["Spring Cloud","Neo4j","Kafka","Eureka","JWT Gateway","Zipkin"],
    github: "https://github.com/ARONAGENT/Linkedin_Microservice_Social_Media_Platform",
    accent: "#606C38",
    stat: { label: "Services", value: "6" },
    stat2: { label: "Tracing", value: "Zipkin" },
  },
  {
    num: "003", label: "AI · Education · Analytics",
